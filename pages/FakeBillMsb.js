...
import nen1 from "../access/img/msb/demo.png";

function FakeBillMsb() {
  ...
  return (
    <div className="w-full h-max flex justify-start items-start text-white">
      <div className="w-[60%] h-max m-[2rem] rounded-md bg-[#181F31] p-2 pb-[4rem]">
        <p className="text-2xl m-[1rem]">Tạo bill chuyển khoản MSB</p>
      ...
      <div className="w-[40%] mt-[2rem] pt-[2rem] flex flex-col justify-center items-center">
        ...
        >
          ...
          <div className=" w-[90%] h-full absolute z-40 flex flex-col justify-start items-end text-black">
            <p className="mt-[16rem] font-[700] text-[#363636] text-[14px] mr-4">
              {nameSender}
            </p>
            <p className="mt-[1.2rem] font-[700] text-[#363636] text-[14px] mr-4">
              {amount} VND
            </p>
            <p className="mt-[1.7rem] font-[700] text-[#363636] text-[14px] mr-4">
              {numberClient}
            </p>
            <p className="mt-[2.3rem] font-[700] text-[#363636] text-[14px] mr-4">
              {nameClient}
            </p>
            <p className="mt-[2.3rem] font-[700] text-[#363636] text-[14px] mr-4">
              {content}
            </p>
            <p className="mt-[2.1rem] font-[700] text-[#363636] text-[14px] mr-4">
