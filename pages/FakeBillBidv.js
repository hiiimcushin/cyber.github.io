...
import nen1 from "../access/img/bidv/demo.png";
  ...
  return (
    <div className="w-full h-max flex justify-start items-start text-white">
      <div className="w-[60%] h-max m-[2rem] rounded-md bg-[#181F31] p-2 pb-[4rem]">
        <p className="text-2xl m-[1rem]">Tạo bill chuyển khoản BIDV</p>
        ...
        >
          ...
          <div className="top-0 w-full h-full z-40 relative flex flex-col justify-start items-start text-black">
            <div className="w-full pt-3 pl-4 flex justify-between items-start">
              <p
                className="h-full flex justify-start items-end text-[14px] -translate-y-[12px] text-[#292929]"
                style={{
                  fontWeight: 700,
                  letterSpacing: "2px",
                }}
              ...
              <div className="w-[6rem] h-[0.8rem] flex justify-end items-end  mr-4">
                <div className="flex h-full justify-start items-end w-max">
                  <div
                    className={`w-1 h-[40%] ml-[1px] rounded-[1px] ${
                      wave >= 1 ? "bg-[#292929]" : "bg-[#7a7a7a7a]"
                    }`}
                  ></div>
                  <div
                    className={`w-1 h-[60%] ml-[1px] rounded-[1px] ${
                      wave >= 2 ? "bg-[#292929]" : "bg-[#7a7a7a7a]"
                    }`}
                  ></div>
                  <div
                    className={`w-1 h-[80%] ml-[1px] rounded-[1px] ${
                      wave >= 3 ? "bg-[#292929]" : "bg-[#7a7a7a7a]"
                    }`}
                  ></div>
                  <div
                    className={`w-1 h-[100%] ml-[1px] rounded-[1px] ${
                      wave >= 4 ? "bg-[#292929]" : "bg-[#7a7a7a7a]"
                    }`}
                  ></div>
                </div>
                ...
                <div className="h-full w-[2rem] ml-1 relative">
                  ...
                  <div className="absolute z-10 top-2/4 w-[80%] h-full left-[1px] -translate-y-[56%] ">
                    <div
                      className={`h-full ${
                        percent <= 20 ? "bg-red-600" : "bg-[#292929]"
                      }`}
                      style={{ width: `${percent}%` }}
                    ></div>
                  </div>
          ...
          <div className=" w-[90%] h-full absolute z-40 flex flex-col justify-start items-center text-black ">
            <div className="w-[90%] h-[8rem] mt-[19.6rem] text-center">
              <p className="font-[600] text-[#3b3b3b]">
                Quý khách đã chuyển thành công số tiền{" "}
                <span className="text-[#2A64A7] font-[700]">{amount} VND</span>{" "}
                đến số tài khoản{" "}
                <span className="text-[#2A64A7] font-[700]">
                  {numberClient}
                </span>
                /{" "}
                <span className="text-[#2A64A7] font-[700]">{nameClient}</span>/{" "}
                <span className="text-[#2A64A7] font-[700]">
                  {selectedOption}
                </span>{" "}
                vào lúc {currentDate} {timeSecion}. Nội dung: {content}
              </p>
            </div>
            <p className="mt-[13px] ml-[7rem] font-[700] text-[#3b3b3b]">
              {numberRandom}
            </p>
          </div>
        </div>
