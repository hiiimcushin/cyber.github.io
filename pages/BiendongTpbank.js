...
import nen1 from "../access/img/biendong/tpbank/demo.png";

const BiendongTpbank = () => {
    ...
    <div className="w-full h-max flex justify-start items-start text-white">
      ...
      <div className="w-[40%] mt-[2rem] pt-[2rem] flex flex-col justify-center items-center">
        ...
        >
          ...
          {/* content */}
          <div className=" w-full h-full absolute z-40 flex flex-col justify-start items-center text-black"></div>
        </div>
      </div>
    </div>
  );
