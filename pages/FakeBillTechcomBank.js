...
import wifi1 from "../access/img/phone/wifi-1black.png";
import wifi2 from "../access/img/phone/wifi-2black.png";
import wifi3 from "../access/img/phone/wifi-3black.png";
import pin0 from "../access/img/phone/pin0black.png";
...
import nen1 from "../access/img/teckcombank/demo.png";

const FakeBillTechcomBank = () => {
  ...
  return (
    <div className="w-full h-max flex justify-start items-start text-white">
      <div className="w-[60%] h-max m-[2rem] rounded-md bg-[#181F31] p-2 pb-[4rem]">
        <p className="text-2xl m-[1rem]">Tạo bill chuyển khoản Techcombank</p>
      ...
      <div className="w-[40%] mt-[2rem] pt-[2rem] flex flex-col justify-center items-center">
        ...
        >
          <img
            src={nen1}
            className="h-full object-top object-cover absolute z-10"
          ></img>
          ...
          <div className="top-0 w-full h-full z-40 relative  flex flex-col justify-start items-start text-black">
            <div className="w-full pt-3 pl-4 flex justify-between items-start">
              <p
                className="h-full flex justify-start items-end text-[14px] -translate-y-[12px] text-[#3b3b3b]"
                style={{
                  fontWeight: 700,
                  letterSpacing: "2px",
                }}
              ...
              <div className="w-[6rem] h-[0.8rem] flex justify-end items-end  mr-4">
                <div className="flex h-full justify-start items-end w-max">
                  <div
                    className={`w-1 h-[40%] ml-[1px] rounded-[1px] ${
                      wave >= 1 ? "bg-[#3b3b3b]" : "bg-[#7a7a7a7a]"
                    }`}
                  ></div>
                  <div
                    className={`w-1 h-[60%] ml-[1px] rounded-[1px] ${
                      wave >= 2 ? "bg-[#3b3b3b]" : "bg-[#7a7a7a7a]"
                    }`}
                  ></div>
                  <div
                    className={`w-1 h-[80%] ml-[1px] rounded-[1px] ${
                      wave >= 3 ? "bg-[#3b3b3b]" : "bg-[#7a7a7a7a]"
                    }`}
                  ></div>
                  <div
                    className={`w-1 h-[100%] ml-[1px] rounded-[1px] ${
                      wave >= 4 ? "bg-[#3b3b3b]" : "bg-[#7a7a7a7a]"
                    }`}
                  ></div>
                </div>
                ...
                <div className="h-full w-[2rem] ml-1 relative">
                  ...
                  <div className="absolute z-10 top-2/4 w-[80%] h-full left-[1px] -translate-y-[56%] ">
                    <div
                      className={`h-full ${
                        percent <= 20 ? "bg-red-600" : "bg-[#3b3b3b]"
                      }`}
                      style={{ width: `${percent}%` }}
                    ></div>
                  </div>
            ...
            <div className="mt-[8.4rem] w-full pl-[1.6rem] pr-[1rem] font-[500]">
              <p className="text-[24px] leading-[34px] mt-[1.2rem]">
                Chuyển thành công <br></br> tới {nameClient} <br></br>VND{" "}
                {amount}
              </p>
              <p className="text-[17px] text-[#1b1b1b] mt-[5rem]">
                Ngân hàng {selectedOption}
                <br></br>
                {numberClient}
              </p>
              <p className="text-[17px] text-[#1b1b1b] mt-[2.4rem]">
                {content}
              </p>
              <p className="text-[17px] text-[#1b1b1b] mt-[2.6rem]">
                {currentDate}
              </p>
              <p className="text-[17px] text-[#1b1b1b] mt-[2.6rem]">
                {numberRandom}
...
export default FakeBillTechcomBank;
