...
import bg1 from "../access/img/mbbank/background14.png";
import right from "../access/img/mbbank/right.png";
import share from "../access/img/mbbank/share.png";
...
import another from "../access/img/mbbank/another.png";
function FakeBillMbBank() {
  ...
  return (
    <div className="w-full h-max flex justify-start items-start text-white">
      <div className="w-[60%] h-max m-[2rem] rounded-md bg-[#181F31] p-2 pb-[4rem]">
        <p className="text-2xl m-[1rem]">Tạo bill chuyển khoản MbBank</p>
      ...
      <div className="w-[40%] mt-[2rem] pt-[2rem] flex flex-col justify-center items-center">
        ...
        >
          <img
            src={bg1}
            className="w-full h-[20rem] rounded-b-[2.4rem] object-top object-cover absolute z-10 -translate-y-[0.8rem]"
          ></img>

          <div className="top-0 w-full h-full z-40 relative  flex flex-col justify-start items-center">
            ...
            <img src={right} className="w-[3rem] mt-2"></img>
            <p
              className="text-[#c4c4c4] text-[15px] mt-4"
              style={{
                fontWeight: 400,
              }}
            >
            ...
            <img src={share} className="w-[8rem] mt-4"></img>
            <div className="bg-[#ededed] w-[90%] h-[8rem] rounded-[1.2rem] mt-6 shadow-sm">
              <p
                className="text-[#969696] text-[14px] mt-2 ml-2"
                style={{
                  fontWeight: 500,
                }}
              >
              ...
              <div className="w-full  h-[6rem] flex justify-between items-center text-black">
                <img
                  src={avtBank}
                  className="w-[1.6rem] shadow-md rounded-sm ml-2"
                ></img>
                <div className="h-full  w-[84%] pl-2 flex flex-col justify-center items-start">
                  <p className="font-[700]">{nameClient}</p>
                  <p className="font-[500] text-[#333333]">{numberClient}</p>
                  <p className="font-[500] text-[#333333]">{selectedOption}</p>
                </div>
              </div>
            </div>
            <div className="bg-[#ededed] w-[90%] rounded-[1.2rem] mt-4">
              <div className="text-black flex justify-between items-center p-2">
                <p className="text-[#969696] text-[14px] font-[500]">
                  Tài khoản nguồn
                </p>
                <div className=" h-full w-[56%] flex flex-col justify-center items-end">
                  <p className="font-[400]">{numberSender}</p>
                  <p className="font-[700]">{nameSender}</p>
                </div>
              </div>
              <div className="text-black flex justify-between items-center p-2">
                <p className="text-[#969696] text-[14px] font-[500]">
                ...
                <p className="text-[14px] text-[#393939] font-[500]">
                  {content}
                </p>
              </div>
              <div className="text-black flex justify-between items-center p-2">
            ...
            <img src={another} className="w-[90%] mt-4"></img>

            <div className="m-auto bg-[#202020] w-[40%] h-[5px] absolute bottom-1 left-2/4 -translate-x-[50%] rounded-full"></div>
          </div>
        </div>
      </div>
    </div>
