...
import nen1 from "../access/img/vietinbank/demo.png";

const FakeBillVietinBank = () => {
  ...
  let lastFourCharacters = numberSender.slice(-4);
  ...
  return (
    <div className="w-full h-max flex justify-start items-start text-white">
      <div className="w-[60%] h-max m-[2rem] rounded-md bg-[#181F31] p-2 pb-[4rem]">
        <p className="text-2xl m-[1rem]">Tạo bill chuyển khoản Vietinbank</p>
        ...
        >
          ...
          <div className="top-0 w-full h-full z-40 relative flex flex-col justify-start items-start text-black">
            <div className="w-full pt-3 pl-4 flex justify-between items-start">
              <p
                className="h-full flex justify-start items-end text-[14px] -translate-y-[12px] text-white"
                style={{
                  fontWeight: 700,
                  letterSpacing: "2px",
                }}
          ...
          {/* content */}
          <div className=" w-[90%] h-full absolute z-40 flex flex-col justify-start items-end text-black ">
            <div className="w-[50%] h-[4rem] text-[12px] font-[600] text-[#a0a0a0] mt-[7rem] flex flex-col justify-center items-end">
              <p>
                {currentDate} {currentTime}
              </p>
              <p>{numberRandom}</p>
            </div>
            <div className="text-[#292929] w-[65%] h-[3.4rem] mt-[4.4rem] flex flex-col justify-center items-end text-[14px] font-[600]">
              <p>********{lastFourCharacters}</p>
              <p>{nameSender}</p>
            </div>
            <div className="text-[#122A45] w-[65%] h-[4rem] flex flex-col justify-center items-end text-[14px] font-[700]">
              <p>{numberClient}</p>
              <p>{nameClient}</p>
            </div>
            <div className="text-[#292929] w-[65%] h-[2rem] flex flex-col justify-center items-end text-[14px] font-[600]">
              <p>{selectedOption}</p>
            </div>
            <div className="text-[#24578E] w-[65%] h-[4rem] flex flex-col justify-center items-end text-[14px] font-[700]">
              <p>{amount} VND</p>
              <p>{amountInWords} Đồng</p>
            </div>
            <div className="text-[#292929] w-[65%] h-[2rem] flex flex-col justify-center items-end text-[14px] font-[600]">
              <p>Miễn phí</p>
            </div>
            <div className="text-[#292929] w-[65%] h-[2rem] mt-1 flex flex-col justify-center items-end text-[14px] font-[600]">
...
export default FakeBillVietinBank;
