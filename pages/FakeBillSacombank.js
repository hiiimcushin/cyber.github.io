...
import nen1 from "../access/img/sacombank/demo.png";

function FakeBillSacombank() {
  ...
  return (
    <div className="w-full h-max flex justify-start items-start text-white">
      <div className="w-[60%] h-max m-[2rem] rounded-md bg-[#181F31] p-2 pb-[4rem]">
        <p className="text-2xl m-[1rem]">Tạo bill chuyển khoản Sacombank</p>
      ...
      <div className="w-[40%] mt-[2rem] pt-[2rem] flex flex-col justify-center items-center">
        ...
        >
          ...
          <div className=" w-[90%] h-full absolute z-40 flex flex-col justify-start items-center text-black ">
            <div className="w-full h-[5.6rem] mt-[15.9rem] flex flex-col justify-start items-center">
              <p className="font-[500] text-[#585858] text-[16px]">
                {numberClient} ({nameClient})
              </p>
              <p
                className=" text-[#002F71] text-[16px]"
                style={{
                  fontWeight: 650,
                }}
              >
              ...
              <p className="font-[500] text-[#949494] text-[16px]">
                {timeSecion} {currentDate}
              </p>
            </div>
            <div className="w-full flex flex-col justify-start items-end mt-[0.8rem]">
              <p className="font-[500] text-[#474747] text-[16px]">
                {numberRandom}
              </p>
              <p className="font-[500] text-[#474747] text-[16px] mt-[0.8rem] w-[66%] text-end ">
                Chuyển tiền từ TK sacombank đến TK NH nội địa
              </p>
              <p className="font-[500] text-[#474747] text-[16px] mt-[0.5rem]">
                {numberSender}
              </p>
              <p className="font-[500] text-[#474747] text-[16px] mt-[0.8rem]">
                {numberClient}
              </p>
              <p className="font-[500] text-[#474747] text-[16px] mt-[0.8rem]">
                {selectedOption}
              ...
              <p className="font-[700] text-[#1c1c1c] text-[16px] mt-[3rem]">
                {amount}
              </p>
            </div>
          </div>
...
export default FakeBillSacombank;
