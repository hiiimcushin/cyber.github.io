...
import nen1 from "../access/img/acb/demo (1).png";

function FakeBillAcb() {
  ...
  return (
    <div className="w-full h-max flex justify-start items-start text-white">
      <div className="w-[60%] h-max m-[2rem] rounded-md bg-[#181F31] p-2 pb-[4rem]">
        <p className="text-2xl m-[1rem]">Tạo bill chuyển khoản ACB</p>
      ...
      <div className="w-[40%] mt-[2rem] pt-[2rem] flex flex-col justify-center items-center">
        ...
        >
            ...
            <div className="w-full pt-3 pl-4 flex justify-between items-start">
              ...
              <div className="w-[6rem] h-[0.8rem] flex justify-end items-end  mr-4">
                ...
                <div className="h-full w-[2rem] ml-1 relative">
                  ...
                  ></img>
                  <div className="absolute z-10 top-2/4 w-[80%] h-full left-[2px] -translate-y-[56%] ">
                    <div
                      className={`h-full ${
          ...
          <div className=" w-full h-full absolute z-40 flex flex-col justify-start items-center text-black ">
            <p className="mt-[10rem] text-[20px] text-[#0C6CC2] font-[700]">
              {amount} VND
            </p>
            <p className="font-[400] text-[#5b5b5b] mt-1">
              {amountInWords} đồng
            </p>
            <div className="w-[80%]  mt-[4.4rem] flex flex-col justify-start items-end font-[500] text-[#5d5d5d]">
              <p>
                {currentDate} - {timeSecion}
              </p>
              <p className="mt-4">{currentDate}</p>
            </div>
            <div className="w-[80%] h-[3rem]  mt-[7rem] flex flex-col justify-start items-start">
              <p className="text-[#163FA1] font-[500]">{nameSender}</p>
              <p className="text-[#163FA1] font-[700]">{numberSender}</p>
            </div>
            <div className="w-[80%] h-[7rem] mt-[3.8rem] flex flex-col justify-start items-end text-[14px] font-[500] text-[#5d5d5d] ">
              <p className="h-[36%] w-[60%]  flex justify-end items-center text-end">
                {nameClient}
              </p>
              <p className=" mt-[10px]">{selectedOption}</p>
              <p className="mt-[17px]">{numberClient}</p>
            </div>
          </div>
        </div>
      </div>
