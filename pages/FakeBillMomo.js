...
import nen1 from "../access/img/momo/demo_bank.png";

function FakeBillMomo() {
  ...
  return (
    <div className="w-full h-max flex justify-start items-start text-white">
      <div className="w-[60%] h-max m-[2rem] rounded-md bg-[#181F31] p-2 pb-[4rem]">
        <p className="text-2xl m-[1rem]">Tạo bill chuyển khoản Momo</p>
      ...
      <div className="w-[40%] mt-[2rem] pt-[2rem] flex flex-col justify-center items-center">
        ...
        >
          ...
          <div className=" w-[90%] h-full absolute z-40 flex flex-col justify-start items-end text-black ">
            <div className="w-full h-[5rem] mt-[6rem] pl-[4.6rem] flex flex-col justify-center items-start">
              <p className="font-[500] text-[#8c8c8c] text-[14px]">
                CHUYỂN TIỀN ĐẾN {nameClient} ({selectedOption})
              </p>
              <p className="font-[700] text-[#393939] text-[26px]">
                -{amount}đ
              </p>
            </div>
            <p className="mt-[2.5rem] text-[14px] mr-[0.6rem] font-[700] text-[#404040]">
              {currentTime} - {currentDate}
            </p>
            <p className="mt-[1.7rem] text-[14px] mr-[1.8rem] font-[700] text-[#404040]">
              {numberRandom}
            </p>
            <p className="mt-[2.3rem] text-[14px] mr-[0.6rem] font-[700] text-[#404040]">
              Miễn phí
            </p>
            <p className="mt-[7.6rem] text-[14px] mr-[0.6rem] font-[700] text-[#404040]">
              {numberClient}
            </p>
            <p className="mt-[0.8rem] text-[14px] mr-[0.6rem] font-[700] text-[#404040]">
              {nameClient}
            </p>
            <p className="mt-[1.1rem] text-[14px] mr-[0.6rem] font-[700] text-[#404040]">
              {selectedOption}
            </p>
            <p className="mt-[1rem] text-[14px] mr-[0.6rem] font-[700] text-[#404040]">
              {amount}VND
            </p>
            <p className="mt-[0.8rem] text-[14px] mr-[0.6rem] font-[700] text-[#404040]">
              {content}
